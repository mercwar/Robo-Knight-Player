...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td colspan="3" class="screenshot"><img src="images/fire-call-2.png" alt="Load to Player Screenshot"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="3" class="screenshot"><img src="images/fire-call-1.png" alt="Load Exportify Screenshot"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="3" class="screenshot"><img src="images/fire-call-3.png" alt="Fire Call Screenshot"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="3" class="screenshot"><img src="images/fire-call-4.png" alt="Craft Exportify Screenshot"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="3" class="screenshot"><img src="images/fire-call-5.png" alt="Craft Youtube Screenshot"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="3" class="screenshot"><img src="images/fire-call-6.png" alt="Upload Exportify Screenshot"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="3" class="screenshot"><img src="images/fire-call-7.png" alt="Upload Youtube Screenshot"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="3" class="screenshot"><img src="images/fire-call-8.png" alt="Download Exportify Screenshot"></td>
    </tr>
    <tr>
    ...
    <tr>
     <td colspan="3" class="screenshot"><img src="images/fire-call-9.png" alt="Download Youtube Screenshot"></td>
    </tr>
  </tbody>
</table>
<hr>
...
📜 Terms of Use
Mercwear is a creative multimedia platform. By accessing Fire Call or any Mercwear service, you agree to:

✅ Use the system for lawful purposes only.

✅ Respect intellectual property rights of artists, developers, and contributors.

✅ Avoid uploading or distributing harmful, malicious, or infringing content.

✅ Accept that Mercwear provides services “as‑is” without guarantees of uninterrupted availability.

🔒 Privacy Policy
Mercwear values your privacy.

🔐 Data Handling: Playlist files (CSV, YouTube IDs, Spotify Exportify) are processed locally within the Fire Call system.

🗂️ Storage: Uploaded files are stored in your session directories and are not shared externally.

🛡️ Security: Mercwear employs session guards and directory validation to prevent unauthorized access.

🚫 No resale of data: Mercwear does not sell or trade user data.

🎵 Intellectual Property
Mercwear respects the rights of creators.

Category	Ownership	Usage Rights
Playlists	Belong to the user who created or uploaded them	Users may edit, upload, and download for personal use
Music Metadata	Belongs to the original artist/label	Used only for playlist compilation and playback
Interface Design	Owned by Mercwear (ROBO ROOK aesthetic, Fire Call UI)	Licensed for personal navigation and use
Logs & Compiler Output	Generated by Fire Call	Users may export and share, but must credit Mercwear


⚠️ Disclaimer
Mercwear is not responsible for external content (e.g., YouTube videos, Spotify tracks) linked through Fire Call.

Playback availability depends on third‑party platforms.

Mercwear provides no warranty for accuracy of metadata or external links.

🛠️ User Responsibilities
📂 Ensure uploaded files are properly formatted (UTF‑8 CSV).

🎧 Respect copyright when sharing playlists externally.

🔄 Keep backups of your playlists — Mercwear is not liable for lost data.

📝 Follow community guidelines when naming or crafting playlists.
</body>
</html>
